...
<script>
    $(document).ready( function () {
        $('#paper_plates_table').DataTable({
            select: false,
            "ajax": {
                "url": "/api/paper-plates",
                "type": "POST",
                headers: {
            ...
            "columns": [
                { "data": "id"},
                { "data": "paper_plates_name",
                    "render": function(data,type,row,meta) {
                        return '<a href="/paper-plates/'+row.id+'">'+data+'</a>';
                    }
                },
                { "data": "created_at",
                ...
                {"defaultContent": "null", "render": function(data,type,row,meta) {
                    return '<a href="/paper-plates/'+row.id+'/edit">'+ '<button>Edit</button>' + '</a>';
                }
                }
            ]
        });
