...
<script>
    $(document).ready( function () {
        $('#fruit_basket_table').DataTable({
            select: false,
            "ajax": {
                "url": "/api/fruit-basket",
                "type": "POST",
                headers: {
            ...
            "columns": [
                { "data": "id"},
                { "data": "fruit_basket_name",
                    "render": function(data,type,row,meta) {
                        return '<a href="/fruit-basket/'+row.id+'">'+data+'</a>';
                    }
                },
                { "data": "created_at",
                ...
                {"defaultContent": "null", "render": function(data,type,row,meta) {
                    return '<a href="/fruit-basket/'+row.id+'/edit">'+ '<button>Edit</button>' + '</a>';
                }
                }
            ]
        });
