...
<ol class='breadcrumb'>
    ...
    <script type="text/x-template" id="grid-template">
        ...
        | orderBy sortKey sortOrders[sortKey]">
                ...
                <td>
                    <a href="/groove-hammer/@{{row.Id}}">@{{row.Name}}</a>
                </td>
                <td>
                    @{{row.Created | formatDate}}
                </td>
                <td ><a href="/groove-hammer/@{{row.Id}}/edit"> <button type="button" class="btn btn-default">Edit</button></a></td>
            </tr>
            </tbody>
        </table>
                    </div>
    ...
    <div> <a href="/groove-hammer/create">
...
@section('scripts')
    ...
    <script>
        ...
        Vue.component('grooveHammer-grid', {
        ...
        var grooveHammer = new Vue({
            ...
            methods: {
                loadData: function () {
                    $.getJSON('api/grooveHammer-vue', function (rows) {
                        this.gridData = rows;
                    }.bind(this));
                }
